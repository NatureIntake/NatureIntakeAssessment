...
// export default function Quiz({ value, unitId , qna}) {
...
//   const { QuestionState, setQuestionState } = useState(qna);
//   const length = 10;

// //   useEffect(()=>{
// //     const path = "/api/QuestionBank";
// //     const qna =  fetch(`${process.env.NEXTAUTH_URL}${path}`, {
// //       method: "GET",
// //       body: JSON.stringify({
// //         id: unitId,
...
//     nextQues < length && setCurrentQuestion(nextQues);
//   };
...
//                   className='w-[49%] py-3 bg-[#099ab3] hover:bg-[#017185] rounded-3xl text-xl shadow-md'
//                 >
//                   {currentQuestion + 1 === length ? "Submit" : "Next"}
//                 </button>
//               </div>
//             </div>
//           </>
...
// //   const path = "/api/getQuestion";
// //   const qna = await fetch(`${process.env.NEXTAUTH_URL}${path}`, {
// //     method: "GET",
// //     body: JSON.stringify({
// //       id: unitId,
// //       lastname: data.lastname,
